...
Preset::Preset(std::string type){
    ...
    if(type == "lsc-narrow-natural"){
        setupPresets(0.85, 1.15, 0.7, 1.3, ofRandom(600, 12600), ofRandom(100, 3000));
    ...
    //Amplitude envelopes range spoken-word-size
        ...
        setupPresets(0.95, 1.1, 0.01, 0.3, ofRandom(600, 12600), ofRandom(100, 3000));
        color = ofColor(255, 70, 138);
    }
    
    
    else if(type == "lsc-wide-veryHigh-verySlow"){
        setupPresets(10., 90.1, 0.0001, 0.003, ofRandom(1600, 22600), ofRandom(100, 3000));
        color = ofColor(70, 180, 138);
    }
    
    
    else if(type == "lsc-narrow-veryLow-verySlow"){
        setupPresets(0.6, 0.9, 0.001, 0.03, ofRandom(1600, 12600), ofRandom(100, 3000));
        color = ofColor(200, 110, 60);
    }
    
    
    else if(type == "granular"){
        setupPresets(0.5, 2.5, 0.00001, 3.3, ofRandom(600, 3000), ofRandom(100, 3000));
...
void Preset::setupPresets(double p0, double p1, double s0, double s1, int dt, int bf){
